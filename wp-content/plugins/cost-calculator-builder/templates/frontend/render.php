		...
		<div ref="calc" class="calc-container" data-calc-id="<?php echo esc_attr( $calc_id ); ?>" :class="[boxStyle, {demoSite: showDemoBoxStyle}]">
			...
			<div class="calc-subtotal calc-list" :class="{loaded: !loader}">
				...
				<div class="calc-list-inner" v-show="getStep === 'finish'">
					...
					<div class="calc-item">
						<div class="ccb-btn-wrap ccb-finish" style="margin-top: 20px">
							<div class="ccb-btn-container calc-buttons invoice-button">
								<?php if ( ! empty( $general_settings['invoice']['use_in_all'] ) && $general_settings['invoice']['use_in_all'] ) : ?>
									<button class="calc-btn-action success" @click="getInvoice">
				...
				<calc-invoice
					...
					company-logo="<?php echo isset( $general_settings['invoice']['companyLogo'] ) ? esc_attr( $general_settings['invoice']['companyLogo'] ) : ''; ?>"
