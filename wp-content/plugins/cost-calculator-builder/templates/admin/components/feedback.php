<div id="ccb-feedback-modal" class="ccb-feedback-modal">
	<div class="feedback-modal-content">
		...
		<span class="feedback-thank-you" style="display: none;">
			<img src="<?php echo esc_url( CALC_URL . '/frontend/dist/img/feedback-thank-you.svg' ); ?>">
		</span>
		...
		<div class="feedback-extra">
			...
			<small>Found a bug in the plugin? <a href="<?php echo esc_url( ccb_get_ticket_url() ); ?>" target="_blank">Click here</a> to report it.</small>
		</div>
		<a href="https://bit.ly/33EkIN3" class="feedback-submit" target="_blank">
			Submit
			<img src="<?php echo esc_url( CALC_URL . '/frontend/dist/img/feedback-external-link.svg' ); ?>">
		</a>
	</div>
</div>
