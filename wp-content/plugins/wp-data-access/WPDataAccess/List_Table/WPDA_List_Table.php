        ...
        if ( $this->show_page_title ) {
            ...
            switch ( $this->page ) {
                case \WP_Data_Access_Admin::PAGE_MAIN:
                    $help_url = 'https://wpdataaccess.com/docs/data-explorer/getting-started/';
                    break;
                case \WP_Data_Access_Admin::PAGE_DESIGNER:
                    $help_url = 'https://wpdataaccess.com/docs/data-designer/getting-started/';
                    break;
                case \WP_Data_Access_Admin::PAGE_PUBLISHER:
                    $help_url = 'https://wpdataaccess.com/docs/data-publisher/data-publisher-getting-started/';
                    break;
                case WPDP::PAGE_MAIN:
                    
                    if ( 'WPDataProjects\\Project\\WPDP_Project_Project_List' === get_class( $this ) ) {
                        $help_url = 'https://wpdataaccess.com/docs/data-projects/data-projects-getting-started/';
                    } else {
                        $help_url = '';
                    }
                ...
                case WPDP::PAGE_TEMPLATES:
                    $help_url = 'https://wpdataaccess.com/docs/project-templates/getting-started/';
                    break;
                default:
            ...
            if ( WPDA_Dashboard::add_actions_to_page_title() && '' !== $help_url ) {
                ...
                ?>" target="_blank"
							   class="wpda_tooltip" title="Plugin Help - opens in a new tab or window">
								<span class="dashicons dashicons-editor-help wpda_title_icon"></span></a>
							<?php 
