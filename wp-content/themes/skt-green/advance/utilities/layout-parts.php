		...
		if(strlen($title) === 0){
			...
			elseif ( $home ){
				if(get_option('page_for_posts') === '0'){
					$title =  esc_html__( 'Blog', 'skt-green' );
				}
				else{
...
if(!function_exists('posterity_title_bar')){
	...
	function posterity_title_bar( $called_position = 'outside', $title = '', $subtitle = '') {
		...
		echo wp_kses_post(posterity_get_title_bar( $called_position, $title, $subtitle));
	}
}
			        ...
			        <div id="post-<?php the_ID(); ?>" <?php post_class('content-box'); ?>>
				        <div class="formatter">
				            ...
				            <div class="real-content">
				                ...
				                <?php
				                wp_link_pages( array(
				                        'before' => '<div id="page-links">'.esc_html__( 'Pages: ', 'skt-green' ),
				                        'after'  => '</div>')
				                );
				                ?>
				            </div>
	...
	function posterity_make_post_grid_filter( $terms, $filter_class = '', $selected_term = '__all', $show_all = true ) {
		if( count( $terms ) ){
			...
			if( $selected_term === '__all' || $show_all ){
				echo '<li '.( $selected_term === '__all' ? ' class="selected"' : '' ).' data-filter="__all"><a href="' . esc_url( posterity_current_url() ) . '">' . esc_html__( 'All', 'skt-green' ) . '</a></li>';
			}
