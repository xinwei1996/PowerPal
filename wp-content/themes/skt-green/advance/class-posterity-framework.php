...
class Posterity_Framework
{
    ...
    function posterity_start()
    {
        ...
        get_template_part('advance/posterity'); 
    ...
    function posterity_setup()
    {
        ...
        register_nav_menus(array(
            'header-menu' => __( 'Site Navigation', 'skt-green' ),
        ));
    }
...
//            'images_manager' //no parent options here
    ...
    function posterity_is_companion_plugin_ready($fail_message = false, $silent = false){
        ...
        if ( empty( $plugins[$plugin_file] ) ) {
            ...
            $label = __( 'Install', 'skt-green' ) . ' : ' . __( 'SKT Templates – Elementor & Gutenberg templates', 'skt-green' );
        }
        ...
        elseif ( is_plugin_inactive( $plugin_path ) ){
            ...
            $label = __( 'Activate', 'skt-green' ) . ' : ' . __( 'SKT Templates – Elementor & Gutenberg templates', 'skt-green' );
        }
        ...
        elseif( version_compare( $plugins[$plugin_file]['Version'], POSTERITY_MIN_COMPANION_VERSION, '<'  ) ){
            ...
            $label = __( 'Update', 'skt-green' ) . ' : ' . __( 'SKT Templates – Elementor & Gutenberg templates', 'skt-green' );
        }

        if(!$ready && !$silent){
            $message = $fail_message ? $fail_message : __( 'This feature requires SKT Templates plugin to be active and in the proper version.', 'skt-green' );
